module Paperclip
  module Validate
    ...
    module ClassMethods
      ...
      def validates_attachment_size(*attribute_names)
        options = ClassMethods.extract_options(attribute_names)
        validators.add(Paperclip::Validate::SizeValidator, attribute_names, options)
      end
      ...
      def validates_attachment_presence(*attribute_names)
        options = ClassMethods.extract_options(attribute_names)
        validators.add(Paperclip::Validate::RequiredFieldValidator, attribute_names, options)
      end
      ...
      def validates_attachment_content_type(*attribute_names)
        options = ClassMethods.extract_options(attribute_names)
        validators.add(Paperclip::Validate::ContentTypeValidator, attribute_names, options)
      end

    end

    class SizeValidator < DataMapper::Validation::Rule
    ...
    class RequiredFieldValidator < DataMapper::Validation::Rule
      def initialize(field_name, options={})
        super
        @field_name, @options = field_name, options
      end
    ...
    class ContentTypeValidator < DataMapper::Validation::Rule
      def initialize(field_name, options={})
        super
        @field_name, @options = field_name, options
      end
    ...
    class CopyAttachmentErrors < DataMapper::Validation::Rule
      def initialize(field_name, options={})
        super
        @field_name, @options = field_name, options
      end
